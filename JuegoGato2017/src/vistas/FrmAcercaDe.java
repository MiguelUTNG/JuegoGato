...
public class FrmAcercaDe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Acerca de Juego del Gato");

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gato_pics/panAcercaDe.png"))); // NOI18N
        jLabel1.setText("jLabel1");

        jLabel2.setText("Un sencillo juego del gato para aplicaciones de escritorio.");

        jLabel3.setText("1.0.1");

        jLabel4.setText("Copyright © 2017  Miguel Angel Camacho Campos  ");
